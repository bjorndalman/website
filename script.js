...
const defaultData = { // ENGELSKA (BAS)
  ...
  education: [
    ...
    },
    {
      ...
      description: `
        <picture>
          <source srcset="images/Qualification-Badge-K3-Ranger.webp" type="image/webp">
          <img src="images/Qualification-Badge-K3-Ranger.jpg" alt="Ranger badge" style="height: 18px; vertical-align: middle; margin-right: 5px;">
      </picture> 
      Completed advanced basic military training as a Ranger (Jägare). Experience from the Life Regiment Hussars (K3)..."
    }
  ],
  experience: [
    {
    ...
    },
    {
      ...
      years: " - 2020",
      // KORRIGERAD: Fixat grammatik (I have/My experience istället för I has/Their)
...
// KORRIGERAD: Hanterar nu radbrytningar korrekt för strängar
function renderDescription(descriptionData) {
  ...
  // Om det är en vanlig sträng, bevara radbrytningar om de finns
...
function toggleMobileMenu() {
    ...
    // KORRIGERAD: Bättre hantering av Tailwind-klasser för mjukare utfällning
